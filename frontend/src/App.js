...
const AdvancedSnareplanModal = ({ isOpen, onClose, routes }) => {
  ...
  const [activeTab, setActiveTab] = useState('route_selection'); // 'route_selection', 'overview_map', 'position_verification', 'instructions'
  ...
  const analyzePlayerPosition = () => {
    ...
    // Coverage Berechnung (vereinfacht)
    const maxDistance = 20000; // QED Radius
